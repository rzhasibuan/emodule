...
@section('content')
    ...
    <main class="main-content">
        <div class="content-left">
            ...
            <h2 class="text-2xl font-bold text-gray-900 dark:text-white mt-6 mb-3" style="color: #fff3cd">1. Menjelajahi Modul Pembelajaran</h2>
            ...
            <h2 class="text-2xl font-bold text-gray-900 dark:text-white mt-6 mb-3" style="color: #fff3cd">2. Mengerjakan Kuis</h2>
            <ul class="list-disc list-inside description space-y-2">
            ...
            <h2 class="text-2xl font-bold text-gray-900 dark:text-white mt-6 mb-3" style="color: #fff3cd">3. Melacak Hasil Belajar</h2>
            <ul class="list-disc list-inside description space-y-2">
            ...
            <div class="cta-buttons mt-8">
                <a href="{{ route('listModule') }}" class="primary-btn" style="text-decoration: none">Mulai Belajar Sekarang</a>
                <a href="{{ route('about') }}" class="secondary-btn" style="text-decoration: none">
        ...
        <div class="content-right">
            <div class="hero-placeholder">
                <img src="{{ asset('about.png') }}" alt="Ilustrasi Panduan Penggunaan" class=" rounded-lg shadow-lg" style="width: 100%;"/>
            </div>
        </div>
    </main>
@endsection
